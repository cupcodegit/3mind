					...
					<div class="feature-block col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box">
							...
							<div class="content">
								...
								<div class="title"><a href="Notícias.html">Agende uma Reunião</a></div>
							</div>
						</div>
					</div>
					<!-- Feature Block -->
				...
				<div class="content-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="text text-justify">
							<p><span>Caminha, Reis, Mutin e Moraes</span> é fruto de uma jornada que teve início no ano de 2007, a partir dos esforços conjuntos de dois baianos, contemporâneos da época de escola e do curso de graduação em Direito da Universidade Federal da Bahia: <span>Marcus Vinícius Caminha e João Carlos Reis.</span></p>
						</div>
						<div class="row clearfix">
				...
				<div class="row clearfix">
					...
					<div class="feature-block-two col-lg-3 col-md-6 col-sm-12">
						...
						<div class="inner-box">
							...
							<h3>Início aos cases de Sucesso</h3>
						</div>
					</div>
					<!-- Feature Block Two -->
					<div class="feature-block-two col-lg-3 col-md-6 col-sm-12">
					...
					<div class="inner-box">
						...
						<div class="overlay-box">
							<div class="overlay-inner">
								<div class="content">
									<span class="icon fas fa-clipboard-list"></span>
									<h4><a href="services-detail.html">Direito Administravo</a></h4>
									<a href="areas.php#pills-emp" class="theme-btn btn-style-one">Consultar</a>
								</div>
							</div>
						</div>
