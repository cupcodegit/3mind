<?php $title = 'Políticas de cookies - Tinelli Ferrarini'; include("head.php"); ?>
    <!-- Start Hero Area -->
    <div class="hero-area">
    	<div class="page-header text-align-center have-submenu">
        	<div class="container">
    ...
    <div class="utility-bar">
    	<div class="container">
        	<ul class="template-submenu">
            	...
            	<li><a href="website-terms.php">Termos de uso</a></li>
            	<li class="active"><a href="cookies-policy.php">Política de cookies</a></li>
            </ul>
        </div>
    </div>
    <!-- Main Content -->
