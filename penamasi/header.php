...
<html lang="en">
    ...
    (function () {
        var options = {
            whatsapp: "(+5519) 9 9178 0117  ", // WhatsApp number
...
<script>
	...
	fbq('init', '337748510233001');
	fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=337748510233001&ev=PageView&noscript=1"
/></noscript>
...
})(window,document,'script','dataLayer','GTM-T346TRH');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-T346TRH"
			...
			<header class="theme-main-header">
								...
								<ul class="left-widget">
									<li>
										<ul class="social-icon clearfix">
											<li><a href="https://www.facebook.com/penamasiadvocaciaeconsultoria/" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
											<li><a href="https://www.instagram.com/rogeriopenamasi/" target="_blank"><i class="fa fa-instagram" aria-hidden="true" ></i></a></li>
											<li><a href="https://www.linkedin.com/in/rogerio-pena-masi-8a810629/" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
										</ul>
									</li>
								</ul>
							</div>
				...
				<div class="main-menu-wrapper clearfix">
					<div class="container clearfix">
						<!-- Logo -->
						<div class="logo float-left"><a href="index.php"><img src="images/logo/logo2.png" alt="Logo"></a></div>
